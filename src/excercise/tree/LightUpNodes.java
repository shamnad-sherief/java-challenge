...
// source:- https://practice.geeksforgeeks.org/problems/f7bfa137576243795abb0595962d61b632bbad21/1
...
public class LightUpNodes {
    public static void main(String[] args) {
        ...
        LightUpNodesSolution obj = new LightUpNodesSolution();

        System.out.println(obj.countVertex(N,edges));


    }
}

class LightUpNodesSolution {
